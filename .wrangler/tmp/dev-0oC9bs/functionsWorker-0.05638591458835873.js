...
async function onRequest(context) {
  ...
  const dogImage = dog.images && dog.images.length > 0 ? `${url.origin}/${dog.images[0]}` : `${url.origin}/assets/compressed-for-web-page/Juma_bilagun3.webp`;
  const dogUrl = `${url.origin}/dog/${dogId}`;
  const description = `Conoce a ${dogName}, pastor alem\xE1n de pura raza del criadero Bi Lagun en Donostia, Pa\xEDs Vasco.`;
  const metaTags = `
        <meta property="og:type" content="profile">
        <meta property="og:title" content="${dogName} | Bi Lagun - Pastor Alem\xE1n">
  ...
  return new HTMLRewriter().on("title", {
    element(el) {
      el.setInnerContent(`${dogName} | Bi Lagun - Pastor Alem\xE1n`);
    }
...
// ../../../../../../../../Users/natal/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../../../../../Users/natal/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../../../../../../../../Users/natal/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
